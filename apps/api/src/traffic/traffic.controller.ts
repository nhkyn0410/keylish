...
export class TrafficController {
  ...
  @Post()
  @HttpCode(204)
  @ApiOperation({ summary: "Record a visit (one per session; aggregate-on-write hourly counter)" })
...
export class AdminTrafficController {
  ...
  @Get("traffic")
  @ApiOperation({ summary: "Hourly visit buckets for the range" })
  @ApiOkResponse({ description: "Hourly visit buckets (UTC) for the range." })
