...
Nếu chạy local trên `localhost`, client có fallback về `http://localhost:3001`, nhưng vẫn nên cấu hình env để build/deploy rõ ràng.
...
3. Mở `http://localhost:3000/settings/account`.
