...
| 09  | Deployment & Operation   | Draft      | 0.1.1     | tách local/dev Docker DB với production Supabase; thêm DB guard                        |
...
| Ngày       | Việc                                                                                                                                                                                                                                                                                                                                                                                                                                      |
| ---------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 2026-06-19 | Tách quy trình local/dev khỏi production DB: local dùng Docker Postgres; production env chỉ trên dashboard; thêm guard chặn remote DB khi dev/migrate/seed; admin-web giữ local-only.                                                                                                                                                                                                                                                     |
