...
| 0.1.2     | 2026-06-21 | AI Agent       | Ghi nhận docs refresh: README đã khớp as-built; backlog/PROJECT-STATE được thu gọn.    |
| 0.1.3     | 2026-06-22 | AI Agent       | PROJECT-STATE chuyển sang ACTIVE; entrypoint docs đổi sang checklist bắt đầu làm việc. |
...
- Admin-web UI (Ant Design, scaffold PARTIAL)
...
- Next.js 16 + Ant Design 6 (admin-web PARTIAL)
...
## 2.1. Docs refresh (2026-06-21 → 2026-06-22)

- Thêm `doc/README.md` làm cửa vào tài liệu.
- README gốc đã cập nhật theo as-built: auth, admin API, traffic, user vocab partial, DB Supabase, local-first đúng nghĩa.
- `PROJECT-STATE` được thu gọn còn current snapshot, checklist bắt đầu làm việc, risk/OQ/decision đang có tác động.
- `11-tasks` chuyển `T-01` thành Done và thêm priority cho FR-PVOC-08.
- Ngày 2026-06-22: trạng thái sống chuyển sang ACTIVE.

## 3. V2 (kế hoạch — TODO chưa code)
